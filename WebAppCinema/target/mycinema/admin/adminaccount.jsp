 ...
 <div class="5">
   ...
   <table width="100%">
    ...
    <tr>
         ...
         <th scope="col">
         <div>
             	<a href="${pageContext.servletContext.contextPath}/admin/moviemanager">MOVIE MANAGER</a>
                 </div>
            <div>
                       	<a href="${pageContext.servletContext.contextPath}/admin/addmovie.jsp">ADD MOVIE</a>
                           </div>
           </th>
         <th scope="col">&nbsp;</th>
         <th scope="col">&nbsp;</th>
