   ...
   <tr>
    ...
    <tr>
      <tr>
        <th scope="col">&nbsp;</th>
        <th scope="col">&nbsp;</th>
        <th scope="col"><img src="images/u1.jpg" width="890" height="270" alt=""/></th>
       ...
       <tr>
        ...
        <th scope="col">&nbsp;</th>
        <th scope="col">
        <form name="MovieForm" method="post" action="${pageContext.servletContext.contextPath}/movies">
        <input type="submit" value="Now plaiyng"></form>      <input type="button" value="About Cinema">      <input type="button" value="Log in">     <input type="button" value="My account"></th>
       <th scope="col">&nbsp;</th>
        <th scope="col">&nbsp;</th>
       <th scope="col">&nbsp;</th>
